# Giorno 1: Fondamenta dell'IA Generativa, Filosofia e Setup
...
- **Basi Teoriche e Filosofiche**:
  - Comprendere il funzionamento delle reti neurali artificiali a partire dal parallelismo biologico e superare la visione riduttiva di "pappagalli stocastici".
  - Riconoscere i limiti attuali dell'IA (assenza di coscienza e autoaffermazione) e comprendere la transizione dalla programmazione sintattica all'espressione dell'intento.
- **Paradigm Shift (Vibe Coding & Agentic Engineering)**:
  - Distinguere tra Vibe Coding e Agentic Engineering e comprendere il funzionamento del Loop Agentico e dei 5 componenti di un agente.
